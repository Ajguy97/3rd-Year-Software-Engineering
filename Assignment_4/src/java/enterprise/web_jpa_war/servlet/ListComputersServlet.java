 ...
 * @author o_molloy
 */
@WebServlet(name="ListComputersServlet", urlPatterns={"/ListComputer"})
public class ListComputersServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
         ...
         List computers = computerFacade.findAll();
         request.setAttribute("computerList",computers);
         request.getRequestDispatcher("ListComputers.jsp").forward(request, response);
